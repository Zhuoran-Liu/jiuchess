...
//    auto model_path = "E:\\data\\model\\resnet50_v1_515.pt";
...
//    bots[Player::WHITE] = std::make_unique<ExpertBot1>(&net1, 500, 2.0f, whitecollector);
//    bots[Player::BLACK] = std::make_unique<ExpertBot1>(&net1, 500, 2.0f, blackcollector);
//    /*int t = 0;*/
//    for (int i = 0; i < 100; i++) {
